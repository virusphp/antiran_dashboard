...
<body id="sep-content" onload="printSep();">
    ...
    <table class="table table-content">
        ...
        <tr>
            ...
            <td class="tt-dua">:</td>
            <td class="nama-fks">{{ $dataSep->asal_faskes }}</td>
            <td>COB</td>
            <td>:</td>
            <td colspan="4">0</td>
        </tr>
        <tr>
            <td>Antrian</td>
            <td>:</td>
            <td>{{ $dataSep->antrian }} {{ $dataSep->nama_poli }}</td>
            <td>Jenis Rawat</td>
            <td>:</td>
            ...
            <td colspan="5"> 
                <i>
                    *Saya Menyetujui BPJS Kesehatan menggunakan Informasi Medis Pasien jika diperlukan 
                     ...
                     <br><strong>{{ !is_null($dataPeserta->prolanisPRB) ? '*Peserta '.$dataPeserta->prolanisPRB : '' }}</strong>
                </i>
            </td>
